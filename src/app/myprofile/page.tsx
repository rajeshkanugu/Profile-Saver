...
const Home = async () => {
    ...
    return (
        <main className="w-screen h-screen text-lg items-center p-10 justify-center flex">
            <div className="items-center justify-center flex gap-10 font-bold flex-col border-2 rounded-xl shadow-lg">
